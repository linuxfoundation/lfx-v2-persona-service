...
// Server lists the persona-service service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Livez  http.Handler
	Readyz http.Handler
...
// New instantiates HTTP handlers for all the persona-service service endpoints
...
func (s *Server) Service() string { return "persona-service" }
...
func (s *Server) MethodNames() []string { return personaservice.MethodNames[:] }

// Mount configures the mux to serve the persona-service endpoints.
...
// MountLivezHandler configures the mux to serve the "persona-service" service
// "livez" endpoint.
...
// calls the "persona-service" service "livez" endpoint.
func NewLivezHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "persona-service")
		var err error
...
// MountReadyzHandler configures the mux to serve the "persona-service" service
// "readyz" endpoint.
...
// calls the "persona-service" service "readyz" endpoint.
