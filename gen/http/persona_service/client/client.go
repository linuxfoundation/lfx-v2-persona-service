...
//
// persona-service client HTTP transport
//
// Command:
...
// Client lists the persona-service service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the persona-service service
// servers.
func NewClient(
	scheme string,
	host string,
...
// Livez returns an endpoint that makes HTTP requests to the persona-service
...
func (c *Client) Livez() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("persona-service", "livez", err)
		}
		return decodeResponse(resp)
	}
}

// Readyz returns an endpoint that makes HTTP requests to the persona-service
...
func (c *Client) Readyz() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("persona-service", "readyz", err)
		}
		return decodeResponse(resp)
	}
}
